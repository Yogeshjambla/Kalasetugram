...
if ($_POST) {
    ...
    if (empty($name) || empty($email) || empty($password) || empty($confirmPassword) || empty($role)) {
        ...
        if ($result['success']) {
            ...
            // Redirect to main page (user is auto-logged in)
            header("Location: ../index.php");
            exit;
        } else {
                                ...
                                <div class="features">
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="bg-white bg-opacity-20 rounded-circle p-2 me-3 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
                                            <i class="fas fa-handshake text-white" style="font-size: 0.8rem;"></i>
                                        </div>
                                        <span>Support Local Artisans</span>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="bg-white bg-opacity-20 rounded-circle p-2 me-3 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
                                            <i class="fas fa-shopping-bag text-white" style="font-size: 0.8rem;"></i>
                                        </div>
                                        <span>Shop Authentic Crafts</span>
                                    </div>
                                    <div class="d-flex align-items-center mb-3">
                                        <div class="bg-white bg-opacity-20 rounded-circle p-2 me-3 d-flex align-items-center justify-content-center" style="width: 32px; height: 32px;">
                                            <i class="fas fa-heart text-white" style="font-size: 0.8rem;"></i>
                                        </div>
